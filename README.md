...
**Time & environment** — Time - Elapsed · Time - Riding · Clock · Sunrise · Sunset ·
Temperature · Battery
...
**Time - Elapsed** runs from the start of the ride including every stop; **Time - Riding** counts
only the moving part, so it is the shorter of the two on any ride with a coffee in it.
